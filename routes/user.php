...
Route::prefix('barantin')->name('barantin.')->group(function () {
    ...
    Route::prefix('update-pjk')->name('pjk.')->group(function () {
        ...
        Route::prefix('pendukung')->name('pendukung.')->group(function () {
            Route::get('datatable/{id}',
                [UpdatePenggunaJasaController::class, 'DokumenPendukungDataTable'])->name('datatable');
            Route::post('store/{id}', [UpdatePenggunaJasaController::class, 'DokumenPendukungStore'])->name('store');
            Route::delete('destroy/{id}',
                [UpdatePenggunaJasaController::class, 'DokumenPendukungDestroy'])->name('destroy');
        });
        Route::prefix('store')->name('store.')->group(function () {
            Route::patch('perorangan/{id}',
                [UpdatePenggunaJasaController::class, 'StoreRegisterPerorangan'])->name('perorangan');
            Route::patch('perusahaan/{id}',
                [UpdatePenggunaJasaController::class, 'StoreRegisterPerusahaan'])->name('perusahaan');
        });
    });
    Route::middleware('auth')->group(function () {
        ...
        Route::prefix('profile')->name('profile.')->group(function () {
            ...
            Route::get('form-keterangan-update',
                [UserProfileController::class, 'FormKeteranganUpdate'])->name('form-keterangan-update');
