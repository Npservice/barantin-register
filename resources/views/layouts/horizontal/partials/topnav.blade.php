                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement"
                            role="button">
                            <i class="ri-pencil-ruler-2-line me-2"></i>UI Elements <div class="arrow-down">
                            </div>
                        </a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-form">
                                    ...
                                    <a href="advance-session-timeout.html" class="dropdown-item">Session
                                        Timeout</a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-layout">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-layout-verti">
                                    <a href="layouts-dark-sidebar.html" class="dropdown-item"
                                        key="t-dark-sidebar">Dark Sidebar</a>
