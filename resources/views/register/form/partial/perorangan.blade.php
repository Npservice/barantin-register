            ...
            <form class="row" id="form-register">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <input class="form-control" type="number" placeholder="Nomor Identitas" id="nomor_identitas" name="nomor_identitas" maxlength="16" oninput="javascript: if (this.value.length >= this.maxLength) this.value = this.value.slice(0, this.maxLength);" value="{{ $baratan->nomor_identitas ?? '' }}">
            ...
            <div>
                <form class="row" id="form-pendukung" novalidate>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control form-control-dokumen" id="nomer_dokumen" name="nomer_dokumen" maxlength="16" oninput="javascript: if (this.value.length >= this.maxLength) this.value = this.value.slice(0, this.maxLength);">
...
<script src="{{ asset('assets/js/pages/form-wizard.perorangan.js') }}"></script>
...
<script>
    $(document).ready(function() {
        $('#jenis_identitas').on('change', function() {
            ...
            $('#jenis_dokumen').val(selectedValue);
        });
        $('#nomor_identitas').on('change', function() {
            var selectedValue2 = $(this).val();
            $('#nomer_dokumen').val(selectedValue2);
        });
    });
