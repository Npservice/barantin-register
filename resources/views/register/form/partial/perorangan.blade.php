        ...
        <div class="tab-pane" id="dokumen-pendukung">
            ...
            <div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" type="text" placeholder="UPT" id="upt"
                            name="upt">
                            <option value="">Select Item</option>
                            <option value="">PASSPORT</option>
                            <option value="">KTP</option>
                            <option value="">NPWP 16 DIGIT</option>
                        </select>
                    </div>
                </div>

                <div class="row mb-3">
                    <label for="jenis_identitas" class="col-sm-2 col-form-label">No Dokumen</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Jenis Identitas"
                            id="jenis_identitas" name="jenis_identitas">
                    </div>
                ...
                <div class="row mb-3">
                    <label for="alamat" class="col-sm-2 col-form-label">Tgl Terbit</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Alamat" id="alamat"
                            name="alamat">
                    </div>
                ...
                <div class="row mb-5">
                    <table id="datatable-dokumen-pendukung" class="table table-bordered dt-responsive nowrap"
                        style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                            <tr>
                                <th>Name</th>
