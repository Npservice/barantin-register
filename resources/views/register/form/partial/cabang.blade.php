            ...
            <form class="row" id="form-register">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" readonly value="{{ $induk->nama_perusahaan }}" type="text" id="" name="">
                            <div class="invalid-feedback" id="feedback"></div>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <input class="form-control" readonly type="text" name="jenis_identitas" id="enis_identitas" value="{{ $induk->jenis_identitas }}" placeholder="Jenis Identitas">
                            <div class="invalid-feedback" id="jenis_identitas-feedback"></div>
                        </div>
                        <div class="col">
                            <input class="form-control" type="number" placeholder="Nomor Identitas" id="nomor_identitas" name="nomor_identitas" readonly value="{{ $induk->nomor_identitas }}">
