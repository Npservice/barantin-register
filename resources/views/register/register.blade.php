...
@section('text')
    Registrasi<br>Permohonan Tindakan Karantina<br>Online
@endsection
@section('content')
    <div class="p-3">
        <form method="POST" action="{{ route('register.new') }}" class="form-horizontal mt-3">
            ...
            <div class="form-group mb-3 row d-none" id="perusahaan-input">
                ...
                <div class="col-9" id="nama-container">
            ...
            <div class="form-group mb-3 row" id="email-input">
            ...
            <div class="form-group mt-4">
                <div class="text-center">
                    <a href="{{ asset('assets/docs/Panduan_Registrasi_PTK_Online_Pengguna_Jasa_ver2.0.pdf') }}" target="_blank"
                        class="btn btn-link">
...
@push('custom-js')
    ...
    <script>
        ...
        // Saat halaman dimuat, sembunyikan semua input kecuali email
        ...
        $('input[name="pemohon"]').change(function() {
            ...
            let namaContainer = $('#nama-container');
            
            if (val === 'perorangan') {
                label.html('Nama Pemohon');
                $('#perusahaan-select').addClass('d-none');
                $('#kategori_perusahaan').parent().addClass('d-none');
                namaContainer.removeClass('col-9').addClass('col-12');
            } else {
                label.html('Nama Perusahaan');
                $('#perusahaan-select').removeClass('d-none');
                $('#kategori_perusahaan').parent().removeClass('d-none');
                namaContainer.removeClass('col-12').addClass('col-9');
            }
            // Pastikan elemen dengan id "perusahaan-input" tidak disembunyikan
