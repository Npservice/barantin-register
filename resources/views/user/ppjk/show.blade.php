              ...
              <form>
                  <div class="row mb-3">
                      <label for="jenis_identitas" class="col-md-3 col-sm-3 col-xs-12 col-form-label">Jenis
                          Identitas</label>
                      <div class="col">
                          <input class="form-control select-item" type="text" id="jenis_identitas_ppjk"
                              name="jenis_identitas_ppjk" value="{{ $data->jenis_identitas_ppjk }}" disabled>
                      </div>
                      <div class="col">
                          <input class="form-control" type="number" disabled placeholder="Nomor Identitas"
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-md-9">
                          <input class="form-control" type="text" disabled placeholder="Nama" id="nama_ppjk"
                              name="nama_ppjk" value="{{ $data->nama_ppjk }}">
                      </div>
                  </div>
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-md-9">
                          <input class="form-control" disabled type="email" placeholder="Email" id="email_ppjk"
                  ...
                  <div class="row mb-3">
                      <label for="tanggal_kerjasama" class="col-md-3 col-form-label">Tgl
                          Kerjasama</label>
                      <div class="col-md-9">
                          <input class="form-control" type="date" disabled placeholder="Tanggal Kerjasama"
          ...
          <div class="col-md-6 col-sm-12">
              ...
              <form>
                  <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                          <input class="form-control" disabled type="text" placeholder="Nama" id="nama_cp_ppjk"
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                          <input class="form-control" disabled type="tel" id="telepon_cp_ppjk"
                              name="telepon_cp_ppjk" value="{{ $data->telepon_cp_ppjk }}">
              ...
              <form>
                  <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                          <input class="form-control" type="text" placeholder="Nama" id="nama_tdd_ppjk"
                              name="nama_tdd_ppjk" disabled value="{{ $data->nama_tdd_ppjk }}">
                  ...
                  <div class="row mb-3">
                      <label for="jenis_identitas" class="col-md-3 col-sm-3 col-xs-12 col-form-label">Jenis
                          Identitas</label>
                      <div class="col">
                          <input class="form-control select-item" type="text" disabled
                              id="jenis_identitas_tdd_ppjk" value="{{ $data->jenis_identitas_tdd_ppjk }}">

                      </div>
                      <div class="col">
                          <input class="form-control" disabled type="number" id="nomor_identitas_tdd_ppjk"
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                          <input class="form-control" disabled type="text" placeholder="Jabatan"
                              id="jabatan_tdd_ppjk" name="jabatan_tdd_ppjk" value="{{ $data->jabatan_tdd_ppjk }}">
                  ...
                  <div class="row mb-3">
                      <label for="alamat" class="col-sm-3 col-form-label">Alamat</label>
                      <div class="col-sm-9">
                          <textarea class="form-control" type="text" disabled placeholder="Alamat" id="alamat_tdd_ppjk"
                              name="alamat_tdd_ppjk">{{ $data->alamat_tdd_ppjk }}</textarea>
