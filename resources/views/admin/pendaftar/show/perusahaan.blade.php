            ...
            <div class="card-header">
                <div class="d-flex justify-content-end">
                    ...
                    {{-- @if (auth()->guard('admin')->user()->upt_id == $uptPusatId) --}}
                        @if ($data->user_id)
                            <button class="btn btn-primary btn-sm me-2" onclick="UserSetting('{{ route('admin.pendaftar.send.user', $data->user_id) }}','{{ $data->nama_perusahaan }}','{{ route('admin.pendaftar.show', $register->id) }}')">
                                Resend Account
                            </button>
                        @else
                            <button class="btn btn-info btn-sm me-2 " onclick="CreateUser('{{ route('admin.pendaftar.create.user', $register->id) }}','{{ $data->nama_perusahaan }}','{{ route('admin.pendaftar.show', $register->id) }}')">
                                Create & Send Account
                            </button>
                        @endif
                    {{-- @endif --}}
                ...
                <form class="row g-3">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" disabled value="{{ $data->preregister->pemohon ?? '' }} {{ $data->preregister->jenis_perusahaan ?? '' }}" type="text">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" type="text" disabled value="{{ $data->nomor_identitas ?? '' }}-{{ $data->nitku ?? '' }}" placeholder="Nomor Identitas" id="nomor_identitas" name="nomor_identitas">
                            </div>
                        </div>
                        <div class="row mb-3">
