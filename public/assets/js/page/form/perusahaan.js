...
$("#nomor_identitas").on("input", function () {
    ...
    if (value.length > 16) {
        ...
        $("#nomor_identitas-feedback").text("Panjang maksimal adalah 16 digit");
    } else {
        $("#nomor_identitas-feedback").text("");
    }
});
$("#nitku").on("input", function () {
    var value = $(this).val();
    // Batasi panjang input hingga 6 digit
    if (value.length > 6) {
        $(this).val(value.slice(0, 6));
        $("#nitku-feedback").text("Panjang maksimal adalah 6 digit");
    } else {
        $("#nitku-feedback").text("");
    }
});
$("#rerata-frekuensi").on("input", function () {
    var value = $(this).val();
    // Batasi panjang input hingga 8 digit
    if (value.length > 8) {
        $(this).val(value.slice(0, 8));
        $("#rerata-frekuensi-feedback").text("Panjang maksimal adalah 8 digit");
    } else {
        $("#rerata-frekuensi-feedback").text("");
    }
});
$(".select-item").select2({
...
$("#lingkup_aktivitas").change(function () {
    ...
    if (selectedOptions && selectedOptions.includes("1")) {
        $("#stat_impor").removeClass("d-none");
    } else {
        $("#stat_impor").addClass("d-none");
    }
});
// $("#lingkup_aktivitas").change(function () {
//     var selectedOptions = $(this).val();
